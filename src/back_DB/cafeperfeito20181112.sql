...
CREATE TABLE `colaborador` (
  ...
  CONSTRAINT `fk_colaborador_empresa_id` FOREIGN KEY (`empresa_id`) REFERENCES `empresaDAO` (`id`)
...
--
-- Table structure for table `empresaDAO`
--

DROP TABLE IF EXISTS `empresaDAO`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `empresaDAO` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `telefoneOperadoraDAO`
--

DROP TABLE IF EXISTS `telefoneOperadoraDAO`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `telefoneOperadoraDAO` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `usuarioDAO`
--

LOCK TABLES `usuarioDAO` WRITE;
/*!40000 ALTER TABLE `usuarioDAO` DISABLE KEYS */;
INSERT INTO `usuarioDAO` VALUES ('$2a$10$tT73rnoTWM9OpHypmWrbZ.5lqtOdMfLhAVOY79eGACX0e6yxSrlqa',1,1),('$2a$10$CZqx5mmOAb8lQCC9wcm/S.CF3QjfVzNYqplmSFlx7RLUPcRr.YJm6',1,2);
/*!40000 ALTER TABLE `usuarioDAO` ENABLE KEYS */;
UNLOCK TABLES;
