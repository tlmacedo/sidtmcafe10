...
public class TabModel {
    ...
    public static void tabelaProduto() {
        try {
            ...
            colunaPrecoFabrica.setCellValueFactory(param -> new SimpleStringProperty(ServiceFormatarDado.getValorFormatado(param.getValue().getValue().getPrecoFabrica().setScale(2).toString(), "moeda", 2)));
            ...
            colunaPrecoVenda.setCellValueFactory(param -> new SimpleStringProperty(ServiceFormatarDado.getValorFormatado(param.getValue().getValue().getPrecoVenda().setScale(2).toString(), "moeda", 2)));
        ...
        try {
            ...
            colunaCnpj.setCellValueFactory(param -> {
                if (param.getValue().getValue().isIsEmpresa())
                    return new SimpleStringProperty(ServiceFormatarDado.getValorFormatado(param.getValue().getValue().getCnpj(), "cnpj", 0));
                else
                    return new SimpleStringProperty(ServiceFormatarDado.getValorFormatado(param.getValue().getValue().getCnpj(), "cpf", 0));
            });
            ...
            colunaIe.setCellValueFactory(param -> {
                ...
                if (param.getValue().getValue().getTabEnderecoVOList() != null)
                    return new SimpleStringProperty(ServiceFormatarDado.getValorFormatado(param.getValue().getValue().ieProperty().getValue(), "ie" + param.getValue().getValue().getTabEnderecoVOList().get(0).getSisMunicipioVO().getUfVO().getSigla(), 0));
