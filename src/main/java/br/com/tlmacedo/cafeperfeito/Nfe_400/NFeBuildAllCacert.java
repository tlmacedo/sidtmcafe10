package br.com.tlmacedo.cafeperfeito.Nfe_400;
...
public class NFeBuildAllCacert {
    ...
    private static void gerarCacert(List<String> listaEnderecos) {
        cacert = Constants.PATH_CLASS_ARQ_NFE_CACERT;
        try {
    ...
    private static void get(String host, KeyStore ks) {
        try {
            ...
            SSLSocket socket = (SSLSocket) factory.createSocket(host, Constants.SIS_PORTA);
