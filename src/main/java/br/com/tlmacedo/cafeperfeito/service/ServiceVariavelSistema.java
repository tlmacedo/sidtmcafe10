...
//        ServiceVariavelSistema.DATA_HORA_STR = ServiceVariavelSistema.DATA_HORA.format(Constants.DTF_DATAHORA);
//        ServiceVariavelSistema.USUARIO_LOGADO_DATA = LocalDate.now();
//        ServiceVariavelSistema.USUARIO_LOGADO_DATA_STR = ServiceVariavelSistema.USUARIO_LOGADO_DATA.format(Constants.DTF_DATA);
//        ServiceVariavelSistema.USUARIO_LOGADO_HORA = LocalTime.now();
//        ServiceVariavelSistema.USUARIO_LOGADO_HORA_STR = ServiceVariavelSistema.USUARIO_LOGADO_HORA.format(Constants.DTF_HORA);
//    }
}
