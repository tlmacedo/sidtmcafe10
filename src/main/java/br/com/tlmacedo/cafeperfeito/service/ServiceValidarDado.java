...
public class ServiceValidarDado implements Constants {
    ...
    public static boolean isEmailHomePageValido(final String value, boolean isEmail, boolean getMsgFaill, String usuario) {
        if (isEmail)
        ...
        if (getMsgFaill) {
            ...
            alertMensagem.setPromptText(String.format("%s, %s: [%s], é %s!", usuario,
    ...
    public static boolean isTelefoneValido(final String value, boolean getMsgFaill, String usuario) {
